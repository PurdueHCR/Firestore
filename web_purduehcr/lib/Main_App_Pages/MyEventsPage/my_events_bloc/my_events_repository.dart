...
class MyEventsRepository {
  ...
  Future updateEvent( UpdateEvent updateEvent) async {
    ...
    APIUtility.setBodyField(body, Event.START_DATE, updateEvent.startDate == null ? null: DateUtils.formatISOTime(updateEvent.startDate));
    APIUtility.setBodyField(body, Event.END_DATE, updateEvent.endDate == null ? null: DateUtils.formatISOTime(updateEvent.endDate));
