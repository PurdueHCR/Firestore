export function createResetHouseCompetitionEmail(path){
    ...
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><a href="`+path+`" style="outline:none" tabindex="-1" target="_blank"> <img align="center" alt="Image" border="0" class="center fixedwidth" src="https://firebasestorage.googleapis.com/v0/b/hcr-points.appspot.com/o/HCRIconSquare.png?alt=media&amp;token=e57f0d62-417b-4fc6-884b-bfe0a0f36223" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; width: 100%; max-width: 211px; display: block;" title="Image" width="211"/></a>
    ...
    <p style="font-size: 28px; line-height: 1.2; text-align: center; word-break: break-word; font-family: Bitter, Georgia, Times, 'Times New Roman', serif; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 28px;">Purdue HCR</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
    ...
    <p style="font-size: 14px; line-height: 1.2; word-break: break-word; font-family: Bitter, Georgia, Times, 'Times New Roman', serif; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 28px;">You requested to reset the house competition.</span></strong></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    ...
    <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"><span style="color: #ff0000;">WARNING, THIS CAN NOT BE UNDONE. </span></p>
    <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin: 0;"> </p>
    <p style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">This will delete:</p>
    <ul>
    <li style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px;">User Data</li>
    <li style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px;">Point Submissions</li>
    <li style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px;">House Scores</li>
    <li style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px;">QR Codes</li>
    <li style="font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px;">Events</li>
    </ul>
    <p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
    <p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">This will not delete:</p>
    <ul>
    <li style="line-height: 1.5; mso-line-height-alt: NaNpx;">Houses</li>
    <li style="line-height: 1.5; mso-line-height-alt: NaNpx;">Point Types</li>
    <li style="line-height: 1.5; mso-line-height-alt: NaNpx;">Rewards</li>
    </ul>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <div align="left" class="button-container" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="`+path+`" style="height:39pt; width:261.75pt; v-text-anchor:middle;" arcsize="49%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><![endif]--><a href="`+path+`" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #3AAEE0; border-radius: 25px; -webkit-border-radius: 25px; -moz-border-radius: 25px; width: auto; width: auto; border-top: 1px solid #3AAEE0; border-right: 1px solid #3AAEE0; border-bottom: 1px solid #3AAEE0; border-left: 1px solid #3AAEE0; padding-top: 10px; padding-bottom: 10px; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:30px;padding-right:30px;font-size:14px;display:inline-block;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span data-mce-style="font-size: 14px; line-height: 28px;" style="font-size: 14px; line-height: 28px;">Yes, I want to delete all house data </span></span></span></a>
    ...
    <p style="font-size: 11px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 13px; margin: 0;"><span style="font-size: 11px;">Copyright © 2020 PurdueHCR, All rights reserved. </span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
